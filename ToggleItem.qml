...
Item {
  ...
  ColumnLayout {
    ...
    MouseArea {
      ...
      onClicked: {
        if (hovered == true) {
          if (selected == false) {
            toggleitem.itemEnabled()
            selected = true
          } else {
            toggleitem.itemDisabled()
            selected = false
          }
        } else {
          selected == selected
  ...
  RowLayout {
    ...
    Kirigami.Icon {
      ...
      Layout.alignment: Qt.AlignCenter
      implicitHeight: textVisible ? Kirigami.Units.iconSizes.small : Kirigami.Units.iconSizes.smallMedium
      implicitWidth: textVisible ? Kirigami.Units.iconSizes.small : Kirigami.Units.iconSizes.smallMedium
      source: iconname
